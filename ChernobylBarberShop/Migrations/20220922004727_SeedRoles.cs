...
namespace ChernobylBarberShop.Migrations
{
...
VALUES 
(N'{User1Id}', N'Test 1', N'Lastname', N'test1@test.com', N'TEST1@TEST.COM', 
N'test1@test.com', N'TEST1@TEST.COM', 0, 
N'AQAAAAEAACcQAAAAEHi4YfFJfX8Uyj0HEabW/UMpZTsvct6K6tmjsGg0GbrUVuHUNzLqVLsRHKYbOQufqg==', 
N'IB57HDGB6EXK2Y5CUSSMHVNKFD6RKMR7', N'cadd732a-725a-4cd4-a7c6-284a7e3af1bc', NULL, 0, 0, NULL, 1, 0)");
...
[PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) 
VALUES 
(N'{User2Id}', N'Test 2', N'Lastname', N'test2@test.com', N'TEST2@TEST.COM', 
